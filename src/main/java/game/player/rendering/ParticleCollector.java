...
public final class ParticleCollector {
    ...
    private static void addParticleIfNecessary(long startX, long startY, long startZ, byte material,
                                               IntArrayList opaqueParticles, IntArrayList transparentParticles, IntArrayList placeParticles,
                                               int xOffset, int yOffset, int zOffset) {
        byte previousMaterial = Game.getWorld().getMaterial(startX + xOffset, startY + yOffset, startZ + zOffset, 0);
        if (previousMaterial == OUT_OF_WORLD || previousMaterial == material) return;
    ...
    private void addBreakParticleEffect(long startX, long startY, long startZ, int lengthX, int lengthY, int lengthZ, byte ignoreMaterial) {
    ...
    private void addPlaceParticleEffect(long startX, long startY, long startZ, int lengthX, int lengthY, int lengthZ, byte material) {
