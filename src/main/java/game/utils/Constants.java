...
public final class Constants {
    ...
    // All materials
    public static final byte AIR = Materials.AIR.id();
    public static final byte OUT_OF_WORLD = Materials.OUT_OF_WORLD.id();
    public static final byte WATER = Materials.WATER.id();
    public static final byte LAVA = Materials.LAVA.id();
    public static final byte GRASS = Materials.GRASS.id();
    public static final byte DIRT = Materials.DIRT.id();
    public static final byte STONE = Materials.STONE.id();
    public static final byte MUD = Materials.MUD.id();
    public static final byte ANDESITE = Materials.ANDESITE.id();
    public static final byte SNOW = Materials.SNOW.id();
    public static final byte SAND = Materials.SAND.id();
    public static final byte SANDSTONE = Materials.SANDSTONE.id();
    public static final byte SLATE = Materials.SLATE.id();
    public static final byte GRAVEL = Materials.GRAVEL.id();
    public static final byte COURSE_DIRT = Materials.COURSE_DIRT.id();
    public static final byte CLAY = Materials.CLAY.id();
    public static final byte MOSS = Materials.MOSS.id();
    public static final byte ICE = Materials.ICE.id();
    public static final byte HEAVY_ICE = Materials.HEAVY_ICE.id();
    public static final byte PODZOL = Materials.PODZOL.id();
    public static final byte RED_SAND = Materials.RED_SAND.id();
    public static final byte RED_SANDSTONE = Materials.RED_SANDSTONE.id();
    public static final byte TERRACOTTA = Materials.TERRACOTTA.id();
    public static final byte RED_TERRACOTTA = Materials.RED_TERRACOTTA.id();
    public static final byte YELLOW_TERRACOTTA = Materials.YELLOW_TERRACOTTA.id();
    public static final byte BLACKSTONE = Materials.BLACKSTONE.id();
    public static final byte RED_GLASS = Materials.RED_GLASS.id();
    public static final byte BLACK_GLASS = Materials.BLACK_GLASS.id();
