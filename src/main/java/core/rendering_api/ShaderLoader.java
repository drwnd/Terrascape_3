...
public final class ShaderLoader {
    ...
    public static Shader loadShader(ShaderIdentifier identifier) {
        return switch (identifier) {
            ...
            case Shaders.OPAQUE_GEOMETRY -> new RenderShader("assets/shaders/Material.vert", "assets/shaders/Opaque.frag", identifier);
            case Shaders.SKYBOX -> new RenderShader("assets/shaders/Skybox.vert", "assets/shaders/Skybox.frag", identifier);
            case Shaders.WATER -> new RenderShader("assets/shaders/Material.vert", "assets/shaders/Water.frag", identifier);
            case Shaders.GLASS -> new RenderShader("assets/shaders/Material.vert", "assets/shaders/Glass.frag", identifier);
